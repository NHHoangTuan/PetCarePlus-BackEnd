...
public class PaymentService {
    ...
    // @Transactional
    // public PaymentUrlResponse createVnPayUrl(UUID userId, CreatePaymentRequest
    // request) {
    // // 1. Validate booking
    ...
    // String vnp_SecureHash = hmacSHA512(vnPayConfig.getHashSecret(),
    // hashData.toString());
    ...
    // handle ipn url
    // public ResponseEntity<Map<String, String>> handleIPNUrl(Map<String, String>
    // params) {
    // String vnp_SecureHash = params.get("vnp_SecureHash");
    ...
    // paymentRepository.findByTransactionCode(vnp_TxnRef);
    ...
    // payment.setVnpayData(vnp_TxnRef, params.get("vnp_BankCode"),
