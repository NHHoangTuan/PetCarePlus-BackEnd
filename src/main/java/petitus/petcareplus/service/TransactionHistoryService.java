...
public class TransactionHistoryService {
    ...
    private Page<TransactionHistoryResponse> getWithdrawalHistory(
        ...
        Page<Withdrawal> withdrawals = withdrawalRepository.findByProviderIdOrderByCreatedAtDesc(providerId, pageable);
    ...
    private TransactionSummaryResponse getProviderTransactionSummary(UUID providerId) {
        ...
        List<WalletTransaction> walletTxs = wallet != null ? walletTransactionRepository.findByWalletId(wallet.getId(),
                PageRequest.of(0, 1000)).getContent() : new ArrayList<>();
    ...
    private TransactionHistoryResponse mapToTransactionHistoryResponseFromPayment(Payment payment) {
        return TransactionHistoryResponse.builder()
                ...
                .transactionDate(payment.getPaymentDate() != null ? payment.getPaymentDate() : payment.getCreatedAt())
